...
- https://github.com/whiskey-sour-org/whiskey_sour/discussions

We do our best to keep the issue tracker tidy and organized, making it useful
for everyone. For example, we classify open issues per perceived difficulty,
making it easier for developers to [contribute to Whiskey Sour](#pull-requests).
...
your Operating System, as well as your Erlang, Elixir and Whiskey Sour versions. Please provide steps to
...
Feature requests are welcome and should be discussed on the [Whiskey Sour Discussions](https://github.com/whiskey-sour-org/whiskey_sour/discussions). But take a moment to find
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/whiskey_sour

   # Navigate to the newly cloned directory
   cd whiskey_sour

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/whiskey_sour_framework/whiskey_sour
   ```
...
This Contributing file is adapted from the https://github.com/phoenixframework/phoenix/blob/main/CONTRIBUTING.md
